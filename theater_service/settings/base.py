...
SPECTACULAR_SETTINGS = {
    "TITLE": "Theater API",
    "DESCRIPTION": (
        "Auth: Bearer JWT (Authorization: Bearer <access>)\n"
        "Default permissions: IsAdminAllOrIsAuthenticatedReadOnly\n"
        "Throttling: anon 100/day, user 1000/day; returns 429 on limit."
    ),
    "VERSION": "1.0.0",
